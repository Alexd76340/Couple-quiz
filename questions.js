...
const softQuestions = [
  ...
  "Quelle partie de ton corp tu aime le plus ?",
  "Quelle partie du corp tu aime le moin ?",
  "Quelle est ton plus grand rêve ?",
  "Ton jeu vidéo préférée ?",
  "Ton sport préféré ?",
  "Ton souvenir préférée avec ton copain / copine ?",
  "Le plus beau cadeau qu'il ou qu'elle ta fait ?",
  "Comment imagine tu ta vie dans 5 ans ?",
  "Quel est le moment de ta relation que tu aimerais revivre ?",
  "Ta chansson préférée ?",
  "La première chose que tu regardé chez lui / elle ?"
];
...
const hotQuestions = [
  ...
  "Avec quel acteur/actrice tu voudrait coucher ?",
  "L'endroit le plus insolite ou tu a fait l'amour ?",
